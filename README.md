...
I (tkosuge) have taken Andrea-san mss fix tools, and will migrate them here. You can see the overview of the tools [from here](https://github.com/ddbj/ddbj_curator_assistant/blob/main/README.md).
