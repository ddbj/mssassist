      ...
      if(len_ann_biosample_id > 0) {
        ...
        if (exists("sample_smp_id") && !is.null(sample_smp_id) && nrow(sample_smp_id) > 0) { # v.1.7
          ...
          if(lines_feature_assembly_gap > 0 & lines_feature_cds > 0) {
            ...
            feature_location$temp_cds <- sub("join","",feature_location$cds_location) # v1.8
            ...
            feature_location$cds_start <- as.numeric(as.character(feature_location$cds_start)) # NAs
            feature_location$cds_end <- as.numeric(as.character(feature_location$cds_end)) # NAs
            # assembly_gap
